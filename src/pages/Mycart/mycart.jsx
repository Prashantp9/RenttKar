      ...
      <>
        ...
        <div className="mycart-sorting-container">
          <div className="mycart-sorting-content">
                <img src={MobileFilter} alt="filter" style={{cursor:"pointer"}}  onClick={() => setShowFilter(!showFilter)}/>
                {showFilter && (
                    <div className="mobile-mycart-filter">
                        <p id="mobile-mycart-filter-content">
                            <img src={SmallCross} alt="smallcross" style={{width:"1rem", height:"1rem", cursor:"pointer"}} onClick={() => setShowFilter(!showFilter)}/>
                            <span>By Price</span>
        ...
        <div className="mycart-suggestion-container">
          <div className="mycart-suggestion-content">
            ...
            <div className="suggestion-button.container" style={{display:"flex", justifyContent:"center",alignItems:"center", width:"100%",marginTop:"2.5rem", marginBottom:"2.5rem"}}>
