    ...
    return (
      <div className="catogery-card-container">
        <div className="catogery-card-content">
          ...
          >
            <SwiperSlide>
              <Catogerycard imgSrc={Console} className="catImg" name="Gaming" />
            </SwiperSlide>

            {/* 2 */}
            <SwiperSlide >
              <Catogerycard imgSrc={Music} className="catImg" name="Music" />
            </SwiperSlide>

            {/* 3 */}
            <SwiperSlide >
              <Catogerycard imgSrc={Camera} className="catImg" name="Camera" />
            </SwiperSlide>

            {/* 4 */}
            <SwiperSlide >
              <Catogerycard imgSrc={Apple} className="catImg" name="Apple" />
            </SwiperSlide>
            ...
            {/* 7 */}
            <SwiperSlide >
              <Catogerycard imgSrc={Boxes} className="catImg" name="Boxes" />
            </SwiperSlide>
  ...
  if (window.innerWidth < 1023) {
    ...
    return (
      <div className="subcatogery-container">
        <div className="subcatogery-content">
          <div className="subcatogery-links">
            <a href="" className="subcatogery-links-gradient">
              PlayStation & More
            </a>
          </div>
            ...
            {showPriceFilter && (
              <div className="mobile-filter-container">
                <div className="mobile-filter-content">
                  <img
                    src={MobileFilterCloseBtn}
                    alt="mobilefilterclosebtn"
                    id="close-btn"
                    onClick={() => setShowPriceFilter(!showPriceFilter)}
                  />
        ...
        <div className="filter-container">
          <div className="filter-content">
            ...
            <div className="filter-types">
              ...
              <div
                className="filter-popularity"
                style={{ cursor: "pointer", userSelect: "none" }}
                onClick={() => setShowPopularityFilter(!showPopularityFilter)}
              >
                <p>Popularity</p>
                <img src={Filter} alt="filter" />
              </div>
