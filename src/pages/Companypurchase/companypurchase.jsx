...
const Companypurchase = () => {
    ...
    return (
      <>
        ...
        <div className="mobile-company-container">
          <div className="mobile-company-content">
            <div className="mobile-company-link-container">
              <p>Not an company purchase?</p>
              <Link to="/individualpurchase">Individual Purchase</Link>
            </div>

            <div className="mobile-company-upload-container-selfie">
              ...
              <div className="mobile-company-upload-desc">
                <p id="mobile-company-upload-text">Upload a Selfie</p>
                ...
                <p id="mobile-company-selfie-reupload">
                  <img
            ...
            <div className="mobile-company-upload-container-enterprise">
              <div className="mobile-company-upload">
                <img
                  src={UploadFile}
                  alt="uploadidentity"
              ...
              <div className="mobile-company-upload-desc">
                <p id="mobile-company-upload-text">Enterprise Verification</p>
                <p id="mobile-company-upload-desc">
                  You can upload documents like GST certificate, Incorporation
                  certificate.
                </p>
              </div>
            </div>

            <div className="mobile-company-upload-container-identity" style={{borderBottom:"1px solid #323232"}}>
              <div className="mobile-company-upload">
                <img
                  src={UploadFile}
                  alt="uploadidentity"
              ...
              <div className="mobile-company-upload-desc" >
                ...
                <p id="mobile-company-upload-desc">
                  ...
                  card/Passport/Driving license. In the context of approval, you
                  need to write us a mail from your enterprise mail id to
                  enterprise@rentkar.com
                </p>
                <Link to="/deliveryaddress">Change Address</Link>
              </div>
            </div>

            <div className="mobile-company-termsconditions-container">
              <div className="mobile-company-termsconditions-content">
                <p className="mobile-company-termscondition-text">
                  Terms & Conditions
                </p>
                <div className="mobile-company-termscondition">
                  <p>
            ...
            <div className="mobile-company-accept-termscondition">
              <label htmlFor="terms">
  ...
  if (window.innerWidth <= 768) {
          ...
          <div className="delivery-content">
            <div className="delivery-left-container">
              ...
              <div className="company-verification-container">
                ...
                <button
                  type="submit"
                  className="company-agree-button"
                  onClick={() => setIsOrderconfirm(!isorderConfirm)}
                >
                  I Agree
                </button>
    ...
    return (
      <>
        <Navbar />
        <div className="company-purchase-container">
          <div className="delivery-container">
            <div className="delivery-content">
              <div className="delivery-left-container">
                <div className="delivery-left-heading-container">
                ...
                <div className="company-verification-container">
                  <div className="company-photo-verification-container">
                    <div
                      className="company-selfie-upload"
                  ...
                  <div className="company-address-verification-container">
                    ...
                    <div className="company-address-desc">
                      ...
                      <p id="upload-address-desc">
                        You can upload directors/Approved Signatorys Aadhar
                        card/Passport/Driving license. In the context of
                        approval, you need to write us a mail from your
                        enterprise mail id to enterprise@rentkar.com
                      </p>
                    </div>
                  </div>
